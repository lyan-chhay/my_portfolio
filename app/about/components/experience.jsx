...
const experiences = [
  {
    ...
    description: " RAG implementation for chatbot.",
    skills: ["RAG", "GPT", "AI"],
  },
  {
    id: 2,
    ...
    company: "Audensiel Healthcare",
    position: "AI Engineer",
    type: "Intern",
    location: "Paris, France",
    description: " AggrePred:  xxxxxxx",
    skills: ["LLM", "graph neural network", "LSTM", "Deep Learning", "AI"],
  },
  {
    id: 3,
    startDate: "Jan 2025",
    endDate: "Present",
    company: "National Social Security Fund Cambodia (NSSF)",
    position: "Data Scientist - Senior Technical Consultant",
    type: "Full time",
    location: "Phnom Penh, Cambodia",
    description: "xxxxxxxxxxx place holder",
    skills: ["python", "MySQL Sever", "PowerBI", "Teamwork"],
  },
];

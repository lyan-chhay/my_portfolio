...
//             </motion.div>
//           </div>
//           <div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 pt-4 backdrop-filter backdrop-blur-sm md:backdrop-blur-none md:backdrop-filter-none bg-background/50 md:bg-transparent md:pt-0">
//             <h1 className="md:bg-background bg-transparent lg:bg-transparent bg-opacity-50 md:px-0 text-foreground text-5xl md:text-8xl font-bold">
//               My Projects
//             </h1>
//             <Hr />
//             <p className="title text-xl mt-4 tracking-wider text-foreground leading-[1.7rem] mb-5">
//               List of my projects that I have done and{" "}
...
//               Intervyou AI
//             </h2>
//             <p className="text-foreground/80 text-justify title text-lg">
//               AI Based interview Preparation Website created to help fresh
//               graduates and job seekers prepare for interviews and optimize
//               their CV through AI-powered features. The website is built using
//               Next.js, TypeScript, Tailwind CSS, Shadcn UI, Prisma, and MySQL
...
//             <Hr variant="long"></Hr>
//             <motion.h1
//               className="text-3xl font-bold mt-3 text-foreground"
//               initial={{ opacity: 0, x: -200 }}
//               whileInView={{ opacity: 1, x: 0 }}
